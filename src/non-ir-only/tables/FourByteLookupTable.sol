...
uint256 constant MaskIncludeFirstFourBytes = 0xffffffff00000000000000000000000000000000000000000000000000000000;
uint256 constant MaskIncludeLastFourBytes = 0xffffffff;
uint256 constant MaskExcludeFirstFourBytes = 0x00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
...
FourByteLookupTable constant EmptyFourByteLookupTable = FourByteLookupTable
    .wrap(0);

function toFourByteLookupTable(
    uint256 _table
...
function write(
    ...
    assembly {
        ...
        let positioned := shl(
            bitsFromRight,
            and(value, MaskIncludeLastFourBytes)
        )
...
function createFourByteLookupTable(
    ...
    table = toFourByteLookupTable(
        positionLT4(0, value0) | positionLT4(1, value1)
    );
}
...
function createFourByteLookupTable(
    ...
    table = toFourByteLookupTable(
        positionLT4(0, values[0]) | positionLT4(1, values[1])
    );
}
